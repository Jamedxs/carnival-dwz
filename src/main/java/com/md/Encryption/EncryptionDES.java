...
public class EncryptionDES {
    ...
    * [描述] 将byte数组转换为表示16进制值的字符串， 如：byte[]{8,18}转换为：0813， 和public static byte[] hexStr2ByteArr(String strIn) 互为可逆的转换过程 <br>
    * [参数]  需要转换的byte数组 <br>
    * [返回] 转换后的字符串 <br>
   ...
   public static String byteArr2HexStr(byte[] arrB) throws Exception {
	  ...
	  * [描述] 将表示16进制值的字符串转换为byte数组， 和public static String byteArr2HexStr(byte[] arrB)互为可逆的转换过程 <br>
	  * [参数] 需要转换的字符串 <br>
	  * [返回] 转换后的byte数组 <br>
