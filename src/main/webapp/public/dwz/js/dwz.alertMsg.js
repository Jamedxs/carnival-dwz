...
$.setRegional("alertMsg", {
	title:{error:"Error", info:"Information", warn:"Warning", correct:"Successful", confirm:"Confirmation",ensure:"Ensure"},
...
var alertMsg = {
	...
	ensure: function(msg, options) {
		var op = {okName:$.regional.alertMsg.butMsg.ok, okCall:ensurelogin, cancelName:$.regional.alertMsg.butMsg.cancel, cancelCall:null};
		$.extend(op, options);
		var buttons = [
			{name:op.okName, call: op.okCall, keyCode:DWZ.keyCode.ENTER}
		];
...
var ensurelogin=function(){
	window.location.href="/carnival/AdminInfo/exitlogin/";
}
